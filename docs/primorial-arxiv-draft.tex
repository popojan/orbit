...
The formula has been verified computationally for all $m$ from 3 to 5000. Performance is efficient:
\begin{itemize}
\item $m = 100$: $<1$ms (37-digit primorial)
\item $m = 1000$: $\approx 2$ms (416-digit primorial)
\item $m = 5000$: $\approx 60$ms (2134-digit primorial)
\end{itemize}

The implementation is available as part of the Orbit paclet:
\begin{center}
\url{https://github.com/popojan/orbit}
\end{center}

All verification scripts, computational experiments, and detailed investigations are publicly available in the repository.
