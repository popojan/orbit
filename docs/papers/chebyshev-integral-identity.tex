...
$\cos(2\pi/n)$ studied by Watkins and Zeitlin~\cite{watkins}, who established
connections between Chebyshev polynomials and cyclotomic fields. However, the
integral identity presented here---involving the \emph{absolute value} of
$f_k$---appears to be new.
