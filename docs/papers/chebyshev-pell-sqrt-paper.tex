...
A remarkable property of $\sigma_2$ emerged during our investigation: it is \emph{algebraically identical} to two successive applications of Newton's method (the classical Babylonian algorithm $x \mapsto (x + d/x)/2$):
\begin{equation}
