...
The primorial function $m\# = \prod_{p \leq m} p$~\cite{OEIS-A034386} appears throughout number theory,
...
\begin{remark}
The alternating sign is essential. Without it, the formula loses the
