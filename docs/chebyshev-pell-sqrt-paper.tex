...
In striking contrast, our method with $m_1=1$ achieves extraordinary super-quadratic convergence, with empirically observed precision growth suggesting $\epsilon_{n+1} \approx \epsilon_n^{6000}$ (see Theorem \ref{thm:convergence}), requiring merely $\log_{6000}(10^6) \approx 1.7$ iterations to reach comparable precision. While each individual iteration incurs greater computational cost, the dramatic reduction in iteration count yields superior overall performance.
