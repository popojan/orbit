...
For any $n \geq 1$ and any $b \in \mathbb{C}$:
\begin{equation}
...
&= n + \beta(n)\cosh\frac{2b\pi}{n} \underbrace{\sum_{k=1}^{n}\cos\frac{(2k-1)\pi}{n}}_{=0}
   - i\beta(n)\sinh\frac{2b\pi}{n} \underbrace{\sum_{k=1}^{n}\sin\frac{(2k-1)\pi}{n}}_{=0}
\end{align}
Both sums vanish by root-of-unity symmetry (the $(2k-1)$-th roots are symmetric about the origin).
\end{proof}
