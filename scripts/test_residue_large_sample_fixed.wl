...
(* Large-scale test: 1000 random numbers - FIXED VERSION *)

Print["================================================================"];
Print["LARGE SCALE TEST: 1000 Random Numbers (FIXED)"];
Print["================================================================"];
Print[""];

(* Compute M(n) - number of factorizations *)
...
(* Generate same sample as before for comparison *)
SeedRandom[12345];
